...
UMLAUTS = pynini.union("ä", "ö", "ü", "ß", "Ä", "Ö", "Ü").optimize()
UMLAUT_MAP = {"ä": "ae", "ö": "oe", "ü": "ue", "Ä": "ae", "Ö": "oe", "Ü": "ue", "ß": "ss", "é": "e"}
UMLAUT_FST = pynini.union(*[pynini.cross(k, v) for k, v in UMLAUT_MAP.items()]).optimize()
NEMO_ALPHA_DE = pynini.union(NEMO_ALPHA, UMLAUTS).optimize()
NEMO_ALPHA_DE_FST = pynini.union(NEMO_ALPHA, UMLAUT_FST).optimize()
